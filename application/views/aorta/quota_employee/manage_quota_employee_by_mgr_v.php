                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <td style='text-align:center;'>
                                            ...
                                            <?php } ?>
                                            <?php if ($isi->KADEP_APPROVE == 1 && $isi->GM_APPROVE == 0 && $isi->DIR_APPROVE == 0) { ?>
                        ...
                        <div style="width: 60%;">
                            <table width="60%" id='filter' border=0px style="outline: thin ridge #DDDDDD">
                                <tr>
                                    ...
                                    <td width="10%">
                                        <button disabled style='border:0;background:#F5811E;width:25px;height:25px;color:white;'></button> : Approved By MGR
                                    </td>
                                    <td width="10%">
                                        <button disabled style='border:0;background:#FFCA01;width:25px;height:25px;color:white;'></button> : Approved By GM
                                    </td>
                                    <td width="10%">
                                        <button disabled style='border:0;background:#55D785;width:25px;height:25px;color:white;'></button> : Approved By DIR*
                                    </td>
                                </tr>
                            </table>
                        </div>
