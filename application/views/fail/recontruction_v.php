...
<head>
	...
	<title>Budgeting &ndash; 404</title>
			...
			<div class="inner">
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<span class="detail">The page you're looking for is under construction. <a href="<?php echo base_url('index.php/home_c'); ?>">Go home instead?</a></span>
