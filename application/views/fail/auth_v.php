...
<head>
	...
	<title>Budgeting &ndash; 401</title>
			...
			<div class="inner">
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<span class="detail">You have no authorization to access this page. <a href="<?php echo base_url('index.php/home_c'); ?>">Go home instead?</a></span>
