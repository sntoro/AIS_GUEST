...
class role_module_c extends CI_Controller {
    ...
    function index($msg = NULL) {
        ...
        $data['content'] = 'role_module/manage_role_module_v';
    ...
    function create_role() {
        ...
        $data['subcontent'] = 'role_module/create_role_v';
        $data['content'] = 'role_module/manage_role_module_v';
    ...
    function edit_role($id) {
        ...
        $data['msg'] = NULL;
        $data['subcontent'] = 'role_module/edit_role_module_v';
        $data['content'] = 'role_module/manage_role_module_v';
    ...
    function role_detail($id) {
        ...
        $data['msg'] = NULL;
        $data['subcontent'] = 'role_module/view_role_module_v';
        $data['content'] = 'role_module/manage_role_module_v';
