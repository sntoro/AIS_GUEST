...
class quota_employee_m extends CI_Model
{
    ...
    function get_data_request_quota_employee_by_dir($dept, $period)
    {
        ...
        return $aortadb->query("  SELECT Q.ID_DOC, Q.TAHUNBULAN, Q.TGL_DOC, K.KD_DEPT, 
                                    ...
                                    SUM(CAST(REPLACE(QUANTITY_QUOTA_PR,',','.') AS DECIMAL(10,2))) AS QUOTA_PR,
                                    SUM(CAST(REPLACE(QUANTITY_QUOTA_IM,',','.') AS DECIMAL(10,2))) AS QUOTA_IM,
                                    Q.KADEP_APPROVE, Q.GM_APPROVE, Q.DIR_APPROVE, 
                                  ...
                                  GROUP BY Q.ID_DOC, Q.TAHUNBULAN, Q.TGL_DOC, K.KD_DEPT,  Q.KADEP_APPROVE, Q.GM_APPROVE, Q.DIR_APPROVE, Q.FLG_FINISH_APPROVE, Q.ALASAN
        ...
        return $aortadb->query("  SELECT Q.ID_DOC, Q.TAHUNBULAN, Q.TGL_DOC, K.KD_DEPT,
                                  ...
                                  WHERE TAHUNBULAN = '$period' AND K.KD_DEPT = '$dept' AND Q.FLG_DELETE = 0
                                      AND (
                                        ...
                                        GROUP BY Q.ID_DOC, Q.TAHUNBULAN, Q.TGL_DOC, K.KD_DEPT,  Q.KADEP_APPROVE, Q.GM_APPROVE, Q.FLG_FINISH_APPROVE, Q.ALASAN
        ...
        return $aortadb->query("  SELECT Q.ID_DOC, Q.TAHUNBULAN, Q.TGL_DOC, K.KD_DEPT,
                                  ...
                                  WHERE TAHUNBULAN = '$period' AND K.KD_DEPT = '$dept' AND Q.FLG_DELETE = 0
                                      AND (
                                        ...
                                        GROUP BY Q.ID_DOC, Q.TAHUNBULAN, Q.TGL_DOC, K.KD_DEPT,  Q.KADEP_APPROVE,  Q.FLG_FINISH_APPROVE, Q.ALASAN
                                  ORDER BY Q.KD_DEPT")->result();
    }
